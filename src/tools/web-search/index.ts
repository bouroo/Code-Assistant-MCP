...
export function registerWebSearchTool(server: McpServer): void {
  server.registerTool(
    ...
    {
      title: 'Web Search',
      description: 'Search the web using DuckDuckGo to retrieve latest information, news, and general web content. Returns structured results with titles, links, and snippets.',
