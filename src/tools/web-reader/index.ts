...
export function registerWebReaderTool(server: McpServer): void {
  server.registerTool(
    "web_reader",
    {
      title: "Web Reader",
      description:
        "Fetch and parse complete content of any webpage. Returns content in various formats (markdown, text, or JSON) with optional metadata, links, and images summaries.",
